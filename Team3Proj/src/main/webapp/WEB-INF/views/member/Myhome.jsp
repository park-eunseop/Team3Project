			...
			<div class="row">
				<div class="col-md-4">
					<c:if test="${empty KakaoUserId}" var="isNotKakaologin">
						...
						<img id="profileImage" alt="이미지 오류" src='<c:url value="/upload/${filedto.f_name}"/>' onerror="this.src='/veve/resources/assets/images/basic_profile.gif';"/>	
					...
					<div class="modal fade" id="modal-container-193710" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
					 ...
					 <a id="modal-751188" href="#modal-container-751188" role="button" class="btn" data-toggle="modal">팔로잉</a>
