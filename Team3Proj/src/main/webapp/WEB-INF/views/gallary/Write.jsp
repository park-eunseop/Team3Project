...
.abort {
  ...
  $(document).ready(function(){
      ...
      {
          var uploadURL = "/imageupload"; //Upload URL
      ...
      <div class="row">
         <div class="col-md-12">
            <form class="form-horizontal" method="post" id="writeform"
               action="<c:url value='/Gallary/GallaryWrite.do'/>" enctype="multipart/form-data" >
               <!-- 씨큐리티 적용:csrf취약점 방어용 -->
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-4">
                     <input type="text" class="form-control" id="title" name="title" title="제목을 입력하세요"
    ...
    <script>
        ...
        $(document).ready(function() {
			...
			$('form').on('submit',function(){
				...
				if($(this).get(0).fileUpload.value==""){
					alert("파일을 첨부하세요.");
					$("#fileUpload").focus();
					return false;					
				}
