...
<head>
  ...
  <link rel="stylesheet" href="<c:url value="/resources/assets/css/open-iconic-bootstrap.min.css"/>">
									...
									<div class="col-md-4">
										<div class="blog-entry ftco-animate">
											...
											<div class="text text-2 pt-2 mt-3">
												<h3 class="mb-4">
													<a href="<c:url value='/Gallary/View.do/?notice_no=${item.notice_no}'/>">${item.title}</a>
												</h3>
