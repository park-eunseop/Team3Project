				...
				<div class="col-md-3">
					<div class="widget_item widget_about">
						...
						<p class="m-top-30">Lorem ipsum dolor sit amet consec tetur
							adipiscing elit nulla aliquet pretium nisi in cursus maecenas nec
							eleifen.</p>
...
<script src="<c:url value="/resources/assets/js/js.isotope.js"/>"></script>
<script src="<c:url value="/resources/assets/js/jquery.collapse.js"/>"></script>
<script src="<c:url value="/resources/assets/js/bootsnav.js"/>"></script>
